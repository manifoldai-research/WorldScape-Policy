...
from worldscape_policy.wam.wan22.attention import flash_attention
...
class WanI2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, crossattn_cache=None, num_img_tokens=0):
        r"""
        Args:
            x(Tensor): Shape [B, L1, C]
            context(Tensor): Shape [B, L2, C]
        """
        context_img = context[:, :num_img_tokens]
        context = context[:, num_img_tokens:]
        b, n, d = x.size(0), self.num_heads, self.head_dim
