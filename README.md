...
| WSP2-RoboTwin2-C2R-Auto | Inference                  | Post-trained RoboTwin 2.0 checkpoint on clean-only dataset for benchmark evaluation               | 35.4 GB       | [wsp_2_posttrain_robotwin2_c2r_auto](https://huggingface.co/manifoldai-research/WorldScape-Policy-2/tree/main/wsp_2_posttrain_robotwin2_c2r_auto)   |
| WSP-RoboTwin2-C2R | Inference                  | Post-trained RoboTwin 2.0 checkpoint on the full clean-plus-randomized dataset for evaluation     | 25.8 GB       | [wsp_2_posttrain_robotwin2_c2r](https://huggingface.co/manifoldai-research/WorldScape-Policy-2/tree/main/wsp_2_posttrain_robotwin2_c2r) |
| WSP-RoboTwin2-Full | Inference                  | Post-trained RoboTwin 2.0 checkpoint on the full clean-plus-randomized dataset for evaluation     | 25.8 GB       | [wsp_2_posttrain_robotwin2_full](https://huggingface.co/manifoldai-research/WorldScape-Policy-2/tree/main/wsp_2_posttrain_robotwin2_full) |
...
This project's source code is released under the [Apache License 2.0](LICENSE).
Third-party components, datasets, and model weights are subject to their
